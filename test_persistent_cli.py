#!/usr/bin/env python3
"""
Test script for the persistent CLI session implementation.
"""
...
async def test_persistent_session():
    """Test persistent CLI session with performance measurement."""
    print("Testing persistent CLI session implementation...")
    ...
    try:
        ...
        print("Creating Claude CLI session...")
        ...
        print(f"CLI process started successfully in {init_time:.2f} seconds")
        ...
        for i, command in enumerate(test_commands, 1):
            print(f"\nTest {i}: Sending command: '{command[:50]}...'")
            ...
            # Wait between commands to see the response
...
if __name__ == "__main__":
    print("Starting persistent CLI session test...")
